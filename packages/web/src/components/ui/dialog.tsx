...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Cap to the viewport and scroll the overflow so a tall dialog never
        // exceeds the screen on small/short devices (was un-scrollable: content
        // ran off-screen with no way to reach it). 100dvh tracks mobile chrome.
