    ...
    data: [
      {
        ...
        description: 'Complete structural design and calculations for buildings',
        code: 'STRUCT-001',
        basePrice: 50000,
        unit: 'per project',
      },
